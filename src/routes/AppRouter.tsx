...
const Books = lazy(() => import("../features/admin/pages/Books"));
...
const ReaderBooks = lazy(() => import("../features/reader/pages/ReaderBooks"));
      ...
      <Router>
        <Routes>
          ...
          >
            ...
            <Route
              path="/reader/*"
              element={<Navigate to="/reader/ReaderDashboard" replace />}
            />
          </Route>
